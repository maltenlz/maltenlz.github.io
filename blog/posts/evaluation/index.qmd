...
[For more special cases and technical details see [our survey article on this topic](https://arxiv.org/abs/2207.01848).]{.column-margin}
...
```{mermaid}
%%| label: fig-rubric
%%| fig-cap: "When to reach for a pretrained model — and when not to."
---
config:
  theme: neutral
  layout: elk
